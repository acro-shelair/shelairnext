...
export default function ServiceEditor({ service, nextPosition }: { service?: Service; nextPosition?: number }) {
  ...
  const { register, handleSubmit, control, watch, setValue, formState: { errors } } = useForm<FormData>({
    ...
    defaultValues: {
      ...
      hero_cta_phone_text:   service?.hero_cta_phone_text   ?? "07 3204 9511",
      hero_cta_phone_link:   service?.hero_cta_phone_link   ?? "tel:0732049511",
      ...
      <section className="space-y-5">
        ...
        <div className="grid md:grid-cols-2 gap-5">
          ...
          <div className="space-y-1.5">
            ...
            <Input {...register("hero_cta_phone_text")} placeholder="07 3204 9511" />
          </div>
          <div className="space-y-1.5">
            <Label>Hero Phone Button Link</Label>
            <Input {...register("hero_cta_phone_link")} placeholder="tel:0732049511" />
          </div>
          <div className="space-y-1.5">
